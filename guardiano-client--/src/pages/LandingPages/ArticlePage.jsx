...
function ArticlePage() {
  ...
  return (
    <div className="flex w-full flex-col gap-6">
      ...
      <section className="border-y-2 border-zinc-900 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <div className="flex aspect-4/3 items-center justify-center rounded-[1.25rem] overflow-hidden mb-8">
            <img
              src={article.image}
              alt={article.title}
          ...
          <div className="prose sm:max-w-none space-y-4 text-zinc-700">
